    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, child) {
          final repository = ref.watch(studentService.notifier);
          return FutureBuilder(
            future: repository.findStudentById(widget.id),
            builder: (context, asyncSnapshot) {
              final student = asyncSnapshot.data;
              if (student != null) {
                            ...
                            LockerProfileItem(
                              children: [
                                ...
                                LockerProfilePart(
                                  ...
                                  description: 'The login of the actual student'
                                      .hardcoded,
                                ),
                                gapW32,
                                LockerProfilePart(
                            ...
                            LockerProfileItem(
                              children: [
                                ...
                                LockerProfilePart(
                                  ...
                                  description:
                                      'The genre of the student'.hardcoded,
                                ),
                                gapW32,
                                LockerProfilePart(
                ...
                return const Center(child: StyledText('Student null'));
              }
            },
          );
        },
